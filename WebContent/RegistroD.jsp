...
<div class="target">
						...
						<form action="RegistroDocente" method="get" class="basic-grey" >
							<input type="hidden" name="opc" value="1" />
							<h1>
								Registro De Docentes <span>Porfavor llene
									...
									<%
										List<RegistroEmpleadoDTO> listLicenciaturaDTO = new ArrayList<RegistroEmpleadoDTO>();
																	...
																	listLicenciaturaDTO = empleadoDAO.retrieveDocente(empleadoDTO);
						 ...
						 <label> </label> <label> <span>Nombre :</span>
								<tr class="color">
			...
			<br></br>	
				<br></br>	
					...
					<%
						...
						listEmpleadoDTO = empleadoRDAO.retrieveDocente(empleadoRDTO);
						...
						///	out.println("<table >");
							out.println("<table  id='Pmoral' ><thead><tr><td>Nombre</td><td>Apellido Paterno</td><td>Apellido Materno</td><td>Número de empleado</td><td>Actualizar</td><td>Eliminar</td></thead><tbody>");
						...
						out.println("<th>");
						out.println("<center>" + empleadoRDTO.getNumeroE() + "</center>");
						out.println("</th>");

						
						out.println("<th>");
						out.println("<center><a href=RegistroDocente?opc=2&id="
								+ empleadoRDTO.getIdEmpleado()
								+ "  class=btn btn-skin pull-right role=button id=ac  onClick=muestra('Pfisica').innerHTML>Actualizar<a/> </center>");
						out.println("</th>");
						out.println("<th>");
						out.println("<center><a href=RegistroDocente?opc=3&id="
								+  empleadoRDTO.getIdEmpleado()
