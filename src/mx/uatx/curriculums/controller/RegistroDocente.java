...
/**
 * Servlet implementation class RegistroDocente
 */
@WebServlet("/RegistroDocente")
public class RegistroDocente extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (opc.equals("2")) {
			...
			updateEmpleadoDTO = empleadoDAO.retrieveDocente(empleadoDTO)
					.get(0);
		...
		if (opc.equals("3")) {
			...
			listEmpleado1DTO = empleado1DAO.retrieveDocente(empleado1DTO);
